      ...
      <div className="flex items-center my-5 justify-between">
        <div className="flex items-center space-x-4">
          ...
          <select
            ...
            className="px-2 py-1 border-2 rounded-lg cursor-pointer"
          >
            <option value="default">-- Cấu trúc --</option>
            <option value="Thi riêng">Thi cuối kỳ</option>
            <option value="Tập trung">Thi giữa kỳ</option>
            <option value="Tập trung">Ôn tập bài học</option>
            <option value="Tập trung">Ôn tập chương</option>
          </select>
          <button
