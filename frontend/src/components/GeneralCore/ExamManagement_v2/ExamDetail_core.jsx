...
const ExamDetail_core = () => {
  ...
  return isLoading ? (
    ...
    <div className="w-full h-full px-12 mx-auto bg-gray-100 py-5 font-nunito">
      <h1 className="text-2xl font-bold mb-4">E0001 - Đề OOP</h1>
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-xl font-bold">Cấu trúc đề: Thi cuối kỳ</h1>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="text-center">
              <th className="px-4 py-2">Thứ tự câu</th>
...
export default ExamDetail_core;
