...
Route::prefix('v1')->group(function () {
    ...
    Route::post('/exams/{examId}/submit', [ExamController::class, 'submitExam']);// Nộp bài thi và tính điểm
    ...
    Route::get('/exams/{examId}/start/{studentId}', [ExamController::class, 'startExam']);// Route để lấy chi tiết bài thi cho sinh viên bắt đầu làm bài
    ...
    Route::post('/subjects/{subjectId}/link-exams', [SubjectController::class, 'linkExam']);// Liên kết môn học với kỳ thi
    ...
    Route::put('/teachers/{id}', [TeacherController::class, 'update']);// Cập nhật thông tin giáo viên
    ...
    Route::post('/add-class-to-exam/{examId}', [ClassExamController::class, 'addClassToExam']);// Thêm lớp học vào kì thi
    Route::post('/remove-class-from-exam/{examId}', [ClassExamController::class, 'removeClassFromExam']);// Xóa lớp học khỏi kì thi
    Route::get('/show-exams-for-class/{classId}', [ClassExamController::class, 'showExamsForClass']);// Hiển thị thông tin về các kỳ thi của lớp học
